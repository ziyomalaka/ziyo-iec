  ...
  return (
    <button
      ...
      className={cn(
        ...
        current && !locked && "bg-[#EEF4FF] ring-2 ring-[#2563EB]",
    ...
    >
      <span
        className={cn(
          ...
          ui === "available" && "border-2 border-[#CBD5E1] text-transparent",
          locked && "border-2 border-[#E2E8F0] text-transparent"
        )}
        aria-hidden
      >
        {completed ? <Check className="h-4 w-4" strokeWidth={2.5} /> : current ? "●" : ""}
      </span>
