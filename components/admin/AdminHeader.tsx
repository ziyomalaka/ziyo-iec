...
const titles: Record<string, string> = {
  ...
  "/admin/software/retraining/umumiy": "Umumiy qayta tayyorlash",
  "/admin/software/retraining/pedagogik": "Pedagogik qayta tayyorlash",
  "/admin/software/retraining/kasbiy": "Kasbiy qayta tayyorlash",
